"""
Reference and utilities for Prop attributes on
RDKit objects (i.e. Atom, Bond, and Mol objects)
"""
...
# REFERENCE FOR "MAGIC" MOL PROP KEYS
...
RDATOM_MAGIC_PROPS = {
    ...
    "_ReactionDegreeChanged": (
        ...
        "if its degree changes in the reaction"
    ),
    "_protected": (
    ...
    "molRxnRole": (
        "which role an atom plays in a reaction "
        "(1=Reactant, 2=Product, 3=Agent), read from/written to CTABs"
    ),
    "smilesSymbol": (
