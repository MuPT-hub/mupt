"""
Markers for indicating the direction of connections,
...
class TraversalDirection(Enum):
    """
    Uniquifying label indicating an orientation "forward" or "backward"
    along a path relative to an arbitrary-but-consistent absolute
