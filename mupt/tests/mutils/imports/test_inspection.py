...
import math
import json  # use these as test cases, since they are pretty stable in stdlib
...
def module_examples() -> tuple[ModuleExample, ...]:
    ...
    """
    return (
        # deliberately mangled to ensure this name never
        # accidentally clashes with a legit module name
...
def test_invalid_module_type_rejected(non_module_type: type) -> None:
    """
    Check that module loading on obviously
    non-module types raises explicit Exception
    """
