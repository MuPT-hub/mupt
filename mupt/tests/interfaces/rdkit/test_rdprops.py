...
def test_rdprop_assignment(
    rdobj: RDObj, prop_value: Any, expected_getter_method_name: str
) -> None:
    ...
    _ = getter(
        prop_key
    )  # NOTE: no need for assert; will raise Exception if value and type targetted by getter disagree
