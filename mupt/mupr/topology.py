...
def canonical_graph_property(graph : nx.Graph) -> str:
    '''
    Return a canonical form based on the graph structure and an ordered coloring
    ...
    return hash(tuple(Counter(deg for node, deg in graph.degree).items())) # temporary, quick-to-compute stand-in for eventual "real-deal" canonical form
