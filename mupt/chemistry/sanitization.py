...
def sanitized_mol(
    ...
    # hydrogen handling?
    cleanmol.UpdatePropertyCache(
        strict=True
    )  # DEV: True is default; decide if this is worth changing down the line
    if add_Hs:
    ...
    if aromaticity_model is not None:
        ...
        )  # prevents final SanitizeMol call from undoing aromatcity model
